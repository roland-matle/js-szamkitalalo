...
function renderGuessList() {
    ...
    for (let { guessValue, result } of guessList) {
        if (result === guessResults.KISEBB) {
            ...
            guessType = "success";
            guessText = `gratulálok, eltaláltad! Tippel száma ${guessList.length}`;
        }

        html += `
                <div class="row">
                    <div class="col col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 alert alert-${guessType}"
                    role="alert">
